...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String NOTIF_GUIDE = "https://material.io/design/patterns/notifications.html";
    ...
    public void updateNotification(){
        ...
        Bitmap mascotBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ic_mascot_1);
        builder.setStyle(new NotificationCompat.BigPictureStyle().bigPicture(mascotBitmap).setBigContentTitle(
